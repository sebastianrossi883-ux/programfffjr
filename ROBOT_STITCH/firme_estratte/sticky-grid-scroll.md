# Componente `sticky-grid-scroll`

- nome cartella: `codrops-sticky-grid-scroll-main`
- funzione mount: `mountStickyGridScroll`
- valore root: `StickyGridScrollOriginal`
- attributo sezione: `data-stitch-native-component="sticky-grid-scroll"`
